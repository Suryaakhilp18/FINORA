        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 text-xs font-bold text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 transition-colors shadow-sm"
            >
              ⚡ 1-Click Judge Demo
            </button>
            <button
              onClick={onOpenLogin}
              className="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-sm transition-colors cursor-pointer"
            >
              Sign In / Launch
            </button>
          </div>
      ...
      <section className="relative pt-16 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        <div className="text-center max-w-3xl mx-auto relative z-10">
          ...
          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto mb-8 font-normal leading-relaxed">
            FINORA uses multimodal Gemini AI and deterministic financial engineering to simulate the exact future consequences of everyday financial decisions — before you make them.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-14">
            <button
              onClick={onInstantDemo}
              className="w-full sm:w-auto px-7 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm shadow-sm flex items-center justify-center space-x-2 transition-colors cursor-pointer"
            >
              <span>Try Instant Demo (21yo SDE)</span>
              <ArrowRight className="w-4 h-4" />
            </button>

            <button
              onClick={onStartApp}
              className="w-full sm:w-auto px-6 py-3 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-900 dark:text-white font-semibold text-sm border border-slate-200 dark:border-slate-800 flex items-center justify-center space-x-2 transition-colors shadow-sm"
            >
        ...
        {/* Hero Interactive Simulation Teaser */}
        <div className="relative max-w-4xl mx-auto rounded-2xl p-6 sm:p-8 finora-card border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg">
          <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-200 dark:border-slate-800">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-mono text-slate-500 dark:text-slate-400 ml-2">decision_simulator.py</span>
            </div>
            <span className="text-[11px] font-mono font-bold text-indigo-600 dark:text-indigo-400">FINORA v1.0 [Verified Math]</span>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 mb-6 font-mono text-xs sm:text-sm">
            ...
            <p className="text-emerald-700 dark:text-emerald-400 mt-2 font-medium">
              <span className="text-emerald-600 dark:text-emerald-400 font-bold">FINORA AI:</span> “Yes, but it alters your risk profile. An upfront ₹65k purchase reduces your cushion from 3.9 months down to 0.8 months. However, choosing a 12-month EMI (₹5,800/mo) keeps ₹76k liquid today.”
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
              ...
              <span className="text-base font-black text-slate-900 dark:text-white font-mono">₹35,000/mo</span>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
              <span className="text-[10px] text-slate-500 dark:text-slate-400 block uppercase font-bold">Current Savings</span>
              <span className="text-base font-black text-slate-900 dark:text-white font-mono">₹82,000</span>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
              <span className="text-[10px] text-slate-500 dark:text-slate-400 block uppercase font-bold">Emergency Cushion</span>
              <span className="text-base font-black text-indigo-600 dark:text-indigo-400 font-mono">3.9 Months</span>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
              <span className="text-[10px] text-slate-500 dark:text-slate-400 block uppercase font-bold">What-If Scenarios</span>
              <span className="text-base font-black text-emerald-600 dark:text-emerald-400 font-mono">5 Paths Analyzed</span>
            </div>
          </div>
        </div>
      </section>
